# Roadmap — IDS2891 Cornerstone

## Milestone 1: Catch Up & Complete All Assignments

Strategy: Prioritize by points (highest value first), then by dependency chain. Many assignments build on each other — background research feeds RQs, which feeds proposals, which feeds the final presentation. We work bottom-up through the chain.

**Note:** Assignment #4 (Lightning Talks Discussion) is already DONE — submitted Feb 2.

- [x] **Phase 1: Library Assignments (#1, #2, #3) + Interest Web Submit** — completed 2026-03-30
- [x] **Phase 2: Crafting Research Questions** — completed 2026-03-30
- [x] **Phase 3: Short Proposal** — completed 2026-03-30
- [x] **Phase 4: Brainstorm Discussion** — completed 2026-03-30
- [x] **Phase 5: Project Check-ins (1, 2, 3)** — completed 2026-03-30
- [x] **Phase 6: Presentation Worksheet** — completed 2026-03-30
- [x] **Phase 7: Research Presentation** — completed 2026-03-30
- [ ] **Phase 8: Co-Curricular Reflection** — blocked pending event attendance
- [x] **Phase 9: Research Documentation** — completed 2026-03-30
- [x] **Phase 10: Revision & Reflection** — completed 2026-03-30
- [x] **Phase 11: Final Project — Interactive Website** — completed 2026-03-30
...
- [x] 01-PLAN-B.md — Update interest web subtopics + export PNG (Assignment #2)
- [x] 01-PLAN-C.md — Search Credo Reference for 2 real sources + finalize citations (Assignment #3)

### Phase 2: Crafting Research Questions
**Goal:** Write 250-word background synthesis + 1-3 research questions + 5 cited sources.
**Points:** 100
**Status:** COMPLETE
**Depends on:** Phase 1 (sources from library assignments feed into this)
**Deliverables:**
- 250-word synthesis document
- 3 research questions (already drafted in Lightning Talks)
- 5+ APA citations

### Phase 3: Short Proposal
**Goal:** 500+ word double-spaced proposal with background, reflection, and research question.
**Points:** 20
**Status:** COMPLETE
**Depends on:** Phase 2 (RQs and synthesis reusable here)
**Deliverables:**
- Section A: Background summary
- Section B: Reflection
- Section C: Research question with scope

### Phase 4: Brainstorm Discussion
**Goal:** Post audience analysis + 2 creative modalities + respond to 2 peers.
**Points:** 20
**Status:** COMPLETE
**Deliverables:**
- Discussion post (audience, needs, 2 creative modalities)
- 2 peer responses (150+ words each)

### Phase 5: Project Check-ins (1, 2, 3)
**Goal:** Submit all three project tracker documents.
**Points:** 120 total (40 + 20 + 60)
**Status:** COMPLETE
**Depends on:** Phases 2-4 (content builds progressively)
**Deliverables:**
- Check-in 1: Basic project tracker
- Check-in 2: Updated tracker
- Check-in 3: Comprehensive research plan with 10+ sources

### Phase 6: Presentation Worksheet
**Goal:** Complete slide-by-slide presentation plan with timing.
**Points:** 20
**Status:** COMPLETE
**Depends on:** Phase 5 (full research plan needed)
**Deliverables:**
- Part I: Design & Prepare (goals, thesis, methods, sources)
- Part II: Create (slide structure with timing for 10-12 min)

### Phase 7: Research Presentation
**Goal:** Create and deliver 10-12 minute research presentation with visual component.
**Points:** 100
**Status:** COMPLETE
**Depends on:** All previous phases
**Deliverables:**
- Visual research presentation (interactive website — NOT PowerPoint)
- 10-12 minutes covering: intro, methods, transdisciplinary connections, implications, advocacy
- Rubric targets: Capstone level on Design, Prepare, Create, Communicate, Reflect
- Meta-narrative: AI was used to build the website that explains AI hardware

### Phase 8: Co-Curricular Reflection
**Goal:** Write 500+ word reflection on 2 FSW co-curricular events attended this semester.
**Points:** 100
**Due:** Apr 5
**Status:** BLOCKED
**Note:** Requires user to identify which FSW events they attended — get this info before planning
**Deliverables:**
- 500+ word reflection
- 2 co-curricular events described with connection to research topic
...
Plans:
- [x] 09-01-PLAN.md — Write assignment-12-research-documentation.md (750-900 words, 13 APA sources, chronological process narrative)
...
**Due:** Apr 19
**Status:** COMPLETE
**Depends on:** Phase 9 (reflects on the full research journey)
**Deliverables:**
- 500+ word essay
...
- [x] 11-04-PLAN.md — Desktop OS foundation: BIOS boot sequence, Win95 desktop shell (7 icons, taskbar, clock), WindowManager (drag/minimize/maximize/close/z-stack), CRT overlay, pixel font, Web Audio sounds — DONE
- [x] 11-05-PLAN.md — Extra apps + polish: interactive Terminal (help/thesis/about/gpu/credits), File Explorer (research tree), Start menu, GSAP per-app window animations (7 unique effects) — DONE
...
Plans:
- [x] 14-01-PLAN.md — Shell pass: boot welcome state, Start menu submenus, 6-icon desktop, window resize/snap/minimize/maximize, taskbar pill focus/restore
**UI hint**: yes
...
|-------|----------------|--------|-----------|
| 1. Library Assignments | 3/3 | Complete | 2026-03-30 |
| 2. Crafting Research Questions | 1/1 | Complete | 2026-03-30 |
| 3. Short Proposal | 1/1 | Complete | 2026-03-30 |
| 4. Brainstorm Discussion | 1/1 | Complete | 2026-03-30 |
| 5. Project Check-ins | 3/3 | Complete | 2026-03-30 |
| 6. Presentation Worksheet | 1/1 | Complete | 2026-03-30 |
| 7. Research Presentation | 1/1 | Complete | 2026-03-30 |
