...
- [x] 11-05-PLAN.md — Extra apps + polish: interactive Terminal (help/thesis/about/gpu/credits), File Explorer (research tree), Start menu, GSAP per-app window animations (7 unique effects)
